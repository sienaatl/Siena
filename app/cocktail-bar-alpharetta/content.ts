 ...
 *
 * Every drink and bottle named here is in lib/site-data.json, which lists twelve
 * house cocktails (nine signature, three classic), three alcohol-free cocktails,
 * 30 wines and 63 spirits. Ingredient lists are the menu's own.
 *
 * Kept distinct from /happy-hour-alpharetta, which covers early evening and small
 * plates. This page is about the drinks and sitting at the bar.
 */
...
export const INTRO = {
  ...
  paras: [
    "Plenty of restaurants have a bar. Fewer have one worth going to on its own. Siena Restaurant &amp; Bar runs twelve house cocktails, a thirty-bottle wine list and sixty-three spirits at 124 Devore Rd in downtown Alpharetta.",
...
export const BLOCKS: Block[] = [
  {
    ...
    intro:
      "Nine signatures and three classics, plus three alcohol-free cocktails made with the same care. If you are not sure where to begin, the Italian Job is the house favourite and the espresso martini is the one that comes back twice. <a href=\"/menus?tab=libations\">See the full list</a>.",
    items: [
      {
      ...
      },
      {
        ...
        alt: "An espresso martini being poured into a coupe at a cocktail bar in Alpharetta, Georgia",
  ...
  },
  {
    ...
    alt: "A bartender misting a cocktail over ice at a cocktail bar in Alpharetta",
    paras: [
  ...
  },
  {
    ...
    alt: "The back bar stocked with bottles at Siena, a cocktail bar in Alpharetta",
    paras: [
  ...
  },
  {
    ...
    cards: [
      {
        title: "Thirty Wines",
        desc: "Provence rosé, Burgundy chardonnay, California cabernet, Italian malbec, and champagne including Moët &amp; Chandon when it is that sort of evening.",
      },
      {
  ...
  },
  {
    ...
    paras: [
      "Doors open at 4pm. Early evening is quiet and easy, and there is a <a href=\"/happy-hour-alpharetta\">happy hour menu</a> from 4 to 7pm if you want a drink and a few small plates without a full sit-down.",
  ...
  },
  {
    ...
    alt: "Whipped feta with char-grilled bread, a small plate to share at a bar in Alpharetta",
    paras: [
      "The whole menu is tapas-style, so drinking here does not mean choosing between a bag of crisps and a full dinner. Hummus, whipped feta, crispy cauliflower and calamari all work with a drink in your other hand.",
...
export const FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: "Yes, from 4 to 7pm, with small plates alongside. <a href=\"/happy-hour-alpharetta\">More on happy hour</a>.",
  },
  {
    q: "When is it busiest?",
    a: "Friday and Saturday evenings, and Friday has live music from 7 to 10pm. Tuesday to Thursday is quieter if you want to actually talk to the person next to you.",
  },
  {
...
export const CLOSING = {
  ...
  paras: [
    "Twelve cocktails, sixty-three spirits and a room worth staying in. No reservation needed if there is a seat.",

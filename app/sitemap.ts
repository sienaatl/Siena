...
const PAGES: { path: string; priority: number; lastModified?: string }[] = [
  { path: "", priority: 1.0 },
  { path: "/mediterranean-restaurant-alpharetta", priority: 0.95, lastModified: "2026-09-24" },
  { path: "/menus", priority: 0.9 },
  { path: "/reservations", priority: 0.9, lastModified: "2026-09-24" },
  ...
  { path: "/downtown-alpharetta-restaurants", priority: 0.9, lastModified: "2026-09-24" },
  { path: "/tapas-restaurant-alpharetta", priority: 0.8 },
  { path: "/fine-dining-restaurant-alpharetta", priority: 0.8 },
  { path: "/seafood-restaurant-alpharetta", priority: 0.8 },
  { path: "/wine-bar-alpharetta", priority: 0.8 },
  { path: "/holiday-parties-alpharetta", priority: 0.9, lastModified: "2026-09-24" },
  { path: "/cocktail-bar-alpharetta", priority: 0.8 },
  { path: "/restaurants-near-ameris-bank-amphitheatre", priority: 0.7, lastModified: "2026-09-24" },
  { path: "/restaurants-near-avalon-alpharetta", priority: 0.7, lastModified: "2026-09-24" },
  { path: "/dinner-alpharetta", priority: 0.7, lastModified: "2026-09-24" },
  { path: "/vegetarian-restaurant-alpharetta", priority: 0.7 },
  { path: "/best-restaurants-alpharetta", priority: 0.8 },
  { path: "/private-dining-alpharetta", priority: 0.85, lastModified: "2026-09-24" },
  { path: "/alpharetta-restaurant-week", priority: 0.85 },
  { path: "/date-night-alpharetta", priority: 0.8, lastModified: "2026-09-24" },
  { path: "/birthday-dinner-alpharetta", priority: 0.8, lastModified: "2026-09-24" },
  { path: "/brunch-alpharetta", priority: 0.8, lastModified: "2026-09-24" },
  { path: "/happy-hour-alpharetta", priority: 0.8, lastModified: "2026-09-24" },
  { path: "/mediterranean-restaurant-near-roswell-ga", priority: 0.8 },
  { path: "/events", priority: 0.8 },
  { path: "/event-inquiry", priority: 0.8 },
  { path: "/live-music-fridays", priority: 0.7, lastModified: "2026-09-24" },
